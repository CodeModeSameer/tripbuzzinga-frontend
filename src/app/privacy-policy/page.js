    ...
    <>
      ...
      <div style={{ minHeight: "60vh", padding: "120px 20px 60px", maxWidth: "1200px", margin: "0 auto" }}>
        ...
        <div style={{ lineHeight: "1.8", color: "#444", fontSize: "1.1rem" }}>
          <p>Your privacy is important to us. This Privacy Policy governs the manner in which Trip Buzzinga collects, uses, maintains and discloses information collected from users.</p>
          <br/>
