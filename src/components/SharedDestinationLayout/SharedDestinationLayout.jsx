              ...
              itineraries.map((itin, i) => {
                ...
                >
                  ...
                  <div className={styles.itinCard}>
                    ...
                    <Link href={`${basePath}/${destination.slug || (destination.name || destination.label || destination.city || '').toLowerCase().replace(/\s+/g, '-')}/${itin.id}`} className={styles.bookBtn}>View More</Link>
                  </div>
